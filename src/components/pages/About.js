  ...
  return (
    ...
    {/* <img className="img" src="Assets/Images/stunning_photograph.jpg" alt="Michael Marlowe" width="30%"/> */}
      ...
      ease-of-life features. Always goal oriented and with focused attention to detail for all tasks. Previous fields of work include
       restaurant management, electrical, and book binding. A tireless work ethic fed by deep satisfaction in a job well done can give anyone 
       confidence with this expansion of their team. Excited to bring a myriad of fun and useful tools to the digital space that increasingly 
